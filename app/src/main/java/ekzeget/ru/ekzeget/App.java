...
/*
- маленький шрифт везде, покрупнее хочется
- в главе каждый стих лучше с новой строки. Цвет номера стиха светлее
- после клика по стиху ничего не происходит, а потом появляется инфа о стихе. Может крутилку какую сделать, чтобы было понятно, что что-то грузится
