package ekzeget.ru.ekzeget.fabrevealmenu.helper;
...
import ekzeget.ru.ekzeget.fabrevealmenu.listeners.AnimationListener;
...
public class AnimationHelper {
    ...
    public void calculateCenterPoints(View viewToReveal, Direction direction) {
        centerX = viewHelper.getSheetRevealCenterX(viewToReveal, direction);
        centerY = viewHelper.getSheetRevealCenterY(viewToReveal, direction);
    }
